...
class RepetitionCount(Metric):
    ...
    Examples:
        ...
        >>> print(result)
        MetricResult(summary={'avg_repetition_count': 2.5}, instance_details=[{'most_repeated_pattern': 'abcabc', 'repetition_count': 3}, {'most_repeated_pattern': 'defgdefg', 'repetition_count': 2}])
    """
